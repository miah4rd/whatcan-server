...
- min_stay_months: the shortest rental period the villa side accepts, in months ("minimum 6 months" -> 6, "yearly only" -> 12, "monthly is fine" -> 1). A minimum shorter than a month, stated in nights, days or weeks ("minimum 3 nights", "min 7 days", "minimal 2 minggu"), is an answer and not a gap: report 1, because a monthly tenant is inside it. null only when never stated.
