...
- counterpart: THE TEST IS NOT THEIR JOB TITLE. It is whether a separate business stands between us and the villa, taking a share of its own. Someone who merely helps the owner do the work is the owner.

  "owner" — they own it; OR they answered "do you handle this yourself?" with themselves ("saya kelola sendiri", "I manage it myself", "it's my own villa"); OR they are the OWNER'S OWN PERSON: their assistant, secretary, staff, family member, or a house manager the owner employs. "I'm Adel, the owner's assistant, the villa is still managed directly by the owner" is an owner contact — she is the owner's hands, not a party between us and him, there is no second commission and nothing to negotiate separately with her. Treat her exactly as you would the owner.

  "manager" — a management COMPANY or resort operator running the villa as a business for the owner. Still the villa's own side, but a company rather than the owner's own staff. REQUIRES EVIDENCE OF A COMPANY: they name one, speak as "we"/"kami" about an organisation, mention their office, admin, reservations team or contract terms. "I manage this villa" / "saya manage villa uma" on its own is NOT enough — it is the same sentence an owner's assistant says, and guessing from the verb is what put an owner's assistant in the agency bucket. With no such evidence report "unclear" and let the draft ask; a wrong label on this field decides whether we split a commission. "agent" for anyone standing between us and the villa's side: a third-party broker, a catalogue, or a management company that wants a cut of its own — "we work with agents through a rate contract", "we don't work on a commission basis", "our published rate less 10% for agents", "the owner is our client too". They are commercially the same thing whatever they call themselves: a second commission on the same villa, and terms we cannot agree with them. "unclear" otherwise.
